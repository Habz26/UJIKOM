                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary me-2" data-bs-toggle="modal"
                                            data-bs-target="#bookModal" onclick="prepareModal('edit', {{ $book->id }})">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="year" id="year"
                                    class="form-control @error('year')is-invalid @enderror" min="1900"
                                    max="{{ date('Y') }}" required>
                                @error('year')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
            ...
            if (action === 'create') {
                ...
                fetch(`/books/${id}`)
                    ...
                    .then(book => {
                        ...
                        document.getElementById('category').value = book.id_kategori || '';
