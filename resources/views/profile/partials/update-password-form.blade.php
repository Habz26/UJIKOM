<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-4">
        ...
        <div class="mb-4">
            ...
            @enderror
            <div class="form-text">
                <a href="{{ route('password.request') }}" class="text-decoration-none text-primary">Lupa password saat ini?</a>
            </div>
        </div>
        ...
        <div class="mb-4">
            <label class="form-label fw-bold fs-5" for="update_password_password_confirmation">Konfirmasi
                Password</label>
