...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-yellow-400 text-sm font-medium leading-5 text-yellow-800 focus:outline-none focus:border-yellow-700 transition duration-150 ease-in-out'
